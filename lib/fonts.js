...
export const getFontSizeForHeading = (level) => {
    const fontSizeMap = {
        1: "max-sm:text-center text-[2.2rem] leading-[2.6rem] lg:text-[3.5rem] mb-8 font-[700] lg:leading-[4rem]",
        2: "max-sm:text-center text-[2rem] leading-[2.4rem] lg:text-[2.5rem] mb-8 font-[600] lg:leading-[3.5rem]",
        3: "max-sm:text-center text-[1.75rem] leading-[2.1rem] lg:text-[2.25rem] mb-5 font-[600] lg:leading-[3rem]",
        ...
        "p": "max-sm:text-center text-[1rem] leading-[1.4] lg:leading-[1.6] lg:text-[1.2rem] mb-6"
    }
