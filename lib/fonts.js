...
export const getFontSizeForHeading = (level) => {
    const fontSizeMap = {
        1: "max-sm:text-center text-[2.2rem] leading-[2.6rem] lg:text-[3rem] mb-8 font-[700] lg:leading-[4rem]",
        ...
        "p": "max-sm:text-center text-[1rem] leading-[1.4] lg:leading-[1.6] lg:text-[1.1rem] mb-6"
    }
